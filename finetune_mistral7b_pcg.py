...
class ScriptArguments(BaseSettings):
    ...
    model_name: Optional[str] = field(
        ...
        metadata={
            "help": "The model you want to train or fine-tune from the Hugging Face Hub. E.g gpt2, gpt2-xl, bert, t5, llama2 etc."
        }
    )
    dataset_name: Optional[str] = field(
        default="iamtarun/python_code_instructions_18k_alpaca",
        metadata={
            "help": "The prefered dataset to use to train the new-fine-tune model"
        }
    )
    ...
    max_steps: int = field(
        default=1000000, metadata={"help": "How many uptimizer update steps to take"}
    )
    ...
    save_steps: int = field(
        default=50, metadata={"help": "Save checkpoint every X update steps."}
    )
    logging_steps: int = field(default=50, metadata={"help": "Log every X update steps."})
